  ...
  return (
    <div className="App dark">
      <Toaster position="top-right" toastOptions={{
        style: { background: "#18181B", border: "1px solid #27272A", color: "#FAFAFA", fontFamily: "Inter, sans-serif" },
      }} />
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            {[
              ...
              <Route key={path} path={path} element={
                <ProtectedRoute><DashboardLayout>{element}</DashboardLayout></ProtectedRoute>
              } />
            ))}
